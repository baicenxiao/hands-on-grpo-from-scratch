...
def compute_group_normalized_rewards(
    ...
    for rollout_response, gt_response in zip(rollout_responses, repeated_ground_truths):
        reward_dict = reward_fn(rollout_response, gt_response)
    ...
    metadata = {
        ...
        'format_mean': torch.mean(format_rewards),
        'format_std': torch.std(format_rewards),
        'answer_mean': torch.mean(answer_rewards),
        'answer_std': torch.std(answer_rewards),
    }
